...
export const ProfileSetupStep = observer(function ProfileSetupStep({ handleStepChange }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-10">
      {/* Header */}
      <CommonOnboardingHeader title="Create your profile." description="This is how you will appear in Cybernetics." />
          ...
          <Controller
            ...
            render={({ field: { value, onChange, ref } }) => (
              <input
                ...
                // oxlint-disable-next-line jsx-a11y/no-autofocus -- intentional: first field of a dedicated onboarding step
                autoFocus
                className={cn(
